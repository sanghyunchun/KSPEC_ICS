...
class AdcActions:
    ...
    def status(self, motor_num: int = 0) -> dict:
        ...
        try:
            state = 'Motor1/2 count are Current counts'
    ...
    async def stop(self, motor_id=0):
        """
        ...
        try:
            if motor_id == 0:
                ...
                return self._generate_response(
                    ...
                    motor_1='Currrent count',
                    motor_2='Current count',
                )
    ...
    async def activate(self, za, vel_set=1) -> dict:
        ...
        try:
            ...
            return self._generate_response(
                ...
                motor_1='Rotate count',
                motor_2='Rotate count',
            )
        except Exception as e:
