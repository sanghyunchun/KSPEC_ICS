...
class gfa_guider:
    ...
    def load_star_catalog(self, crval1, crval2):
        ...
        file_name = self.inpar['paths']['directories']['star_catalog']
    ...
    def select_stars(self, ra1_rad, dec1_rad, ra2_rad, dec2_rad, ra_p, dec_p, flux):
        ...
        mask = (angular_distance_degrees < self.ang_dist) & (flux > self.inpar['catalog_matching']['tolerance']['mag_flux_min'])
        ra = ra_p[mask]
        dec = dec_p[mask]
